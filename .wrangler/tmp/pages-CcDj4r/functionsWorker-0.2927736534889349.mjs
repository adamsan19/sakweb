...
// ../.wrangler/tmp/bundle-avBw6S/checked-fetch.js
...
// lib/utils.js
var norm = /* @__PURE__ */ __name((t) => (t || "").toLowerCase().replace(/[^a-z0-9\s]/g, " ").replace(/\s+/g, " ").trim(), "norm");
function h(str) {
  if (!str) return "";
  return str.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#39;");
}
__name(h, "h");
var p2 = /* @__PURE__ */ __name((t) => {
  const n = norm(t).replace(/\s+/g, "");
  return !n ? "__" : n.length === 1 ? n + "_" : n.slice(0, 2);
}, "p2");
var p3 = /* @__PURE__ */ __name((t) => {
  const n = norm(t).replace(/\s+/g, "");
...
async function handleRequest(context) {
  ...
  try {
    ...
    if (path === "/api/search") {
      ...
      const generateEmptySearch = /* @__PURE__ */ __name(() => ({
        server_time: getServerTime(),
        status: 200,
        msg: "OK",
        result: [],
...
// templates/components/mobile-menu.js
function MobileMenu() {
  return `
    <style>
        .mobile-dropdown {
...
// templates/components/search-modal.js
...
// templates/components/styles.js
function Styles() {
  return `
        :root {
...
// templates/components/breadcrumbs.js
...
// templates/components/pagination.js
...
// ../.wrangler/tmp/pages-CcDj4r/functionsRoutes-0.2939987857713592.mjs
var routes = [
  {
    routePath: "/api/:route*",
    mountPath: "/api",
...
// ../.wrangler/tmp/bundle-avBw6S/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-avBw6S/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.2927736534889349.mjs.map
